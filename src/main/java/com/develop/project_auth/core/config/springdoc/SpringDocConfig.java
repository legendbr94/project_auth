package com.develop.project_auth.core.config.springdoc;

import static org.springframework.http.MediaType.APPLICATION_JSON_VALUE;

import com.develop.project_auth.domain.exception.Problem;
...
public class SpringDocConfig {
  ...
  public OpenAPI openAPI() {
    return new OpenAPI()
        .info(new Info()
            .title("Project Auth")
            .version("v1")
            .description("REST API do Project Auth")
            .license(new License()
                .name("Apache 2.0")
            ...
            .url("https://www.project-auth.com.br")
        ).components(new Components().schemas(
            gerarSchemas()).responses(gerarResponses()));
  }
              ...
              .forEach((httpMethod, operation) -> {
                ...
                switch (httpMethod) {
                  case GET:
                    ...
                    responses
                        .addApiResponse("500", new ApiResponse().$ref(internalServerErrorResponse));
                    break;
                  case POST:
  ...
  private Map<String, Schema> gerarSchemas() {
    ...
    Map<String, Schema> problemObjectSchema = ModelConverters.getInstance()
        .read(Problem.Object.class);
